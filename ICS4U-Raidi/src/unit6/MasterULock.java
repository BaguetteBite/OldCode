...
public class MasterULock extends ConfigurableLock {
    ...
    //Because this lock's digit amount is 4 unlike other locks, a special case is needed
    //New combo array needed to override array of parent class (ConfigurableLock.java)
    int[] combo = new int[arrLength];

    //Constructor for initialization
    //New combo passed as argument as user generates the combo
    public MasterULock(int[] newCombo) {
        ...
        combo = super.generateCombo(0, MAX_COMBO_VALUE, newCombo);
